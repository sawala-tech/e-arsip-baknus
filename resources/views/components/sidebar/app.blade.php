    ...
    <nav class="sidebar card border-0 py-2 mb-4 sticky-top position-sticky top-0">
        <ul class="nav flex-column" id="nav_accordion">
            ...
            <li class="nav-item has-submenu">
                ...
                <ul class="submenu collapse" style="list-style: none;">
                    <li><a class="nav-link text-secondary" href="/laporan/surat-masuk">Surat Masuk </a></li>
                    <li><a class="nav-link text-secondary" href="/laporan/surat-keluar">Surat Keluar </a></li>
                </ul>
            </li>
        </ul>
    </nav>
